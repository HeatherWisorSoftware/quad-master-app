...
namespace QuadMasterApp.Data
{
    public class DatabaseSeeder
    {
        ...
        private async Task SeedPlayersAsync()
        {
            ...
            {
                new Player { FirstName = "John", LastName = "Smith", Ranking = 1840, Email = "john.smith@example.com" },
                new Player { FirstName = "David", LastName = "Johnson", Ranking = 1985, Email = "david.johnson@example.com" },
                new Player { FirstName = "Michael", LastName = "Williams", Ranking = 2105, Email = "michael.williams@example.com" },
                new Player { FirstName = "James", LastName = "Brown", Ranking = 1750, Email = "james.brown@example.com" },
                new Player { FirstName = "FM", LastName = "Robert Davis", Ranking = 2270, Email = "robert.davis@example.com" },
                new Player { FirstName = "Daniel", LastName = "Miller", Ranking = 1890, Email = "daniel.miller@example.com" },
                new Player { FirstName = "William", LastName = "Wilson", Ranking = 1910, Email = "william.wilson@example.com" },
                new Player { FirstName = "Richard", LastName = "Moore", Ranking = 2050, Email = "richard.moore@example.com" },
                new Player { FirstName = "Joseph", LastName = "Taylor", Ranking = 1795, Email = "joseph.taylor@example.com" },
                new Player { FirstName = "Thomas", LastName = "Anderson", Ranking = 1875, Email = "thomas.anderson@example.com" },
                new Player { FirstName = "Charles", LastName = "Jackson", Ranking = 1950, Email = "charles.jackson@example.com" },
                new Player { FirstName = "Christopher", LastName = "White", Ranking = 2125, Email = "christopher.white@example.com" },
                new Player { FirstName = "Edward", LastName = "Harris", Ranking = 1830, Email = "edward.harris@example.com" },
                new Player { FirstName = "Brian", LastName = "Martin", Ranking = 1920, Email = "brian.martin@example.com" },
                new Player { FirstName = "Louis", LastName = "Zhang", Ranking = 1959, Email = "louis.zhang@example.com" },
                new Player { FirstName = "Jonas", LastName = "M Reed Jr.", Ranking = 1959, Email = "jonas.reed@example.com" },
                new Player { FirstName = "Ting", LastName = "Chieh", Ranking = 1927, Email = "ting.chieh@example.com" },
                new Player { FirstName = "FM", LastName = "Aleksa Micic", Ranking = 2278, Email = "aleksa.micic@example.com" },
                new Player { FirstName = "Daniel", LastName = "Wang", Ranking = 2100, Email = "daniel.wang@example.com" },
                new Player { FirstName = "Kevin", LastName = "Thompson", Ranking = 1865, Email = "kevin.thompson@example.com" },
                new Player { FirstName = "Jason", LastName = "Garcia", Ranking = 1975, Email = "jason.garcia@example.com" },
                new Player { FirstName = "Ronald", LastName = "Martinez", Ranking = 1820, Email = "ronald.martinez@example.com" },
                new Player { FirstName = "Jeffrey", LastName = "Robinson", Ranking = 1900, Email = "jeffrey.robinson@example.com" },
                new Player { FirstName = "Amanda", LastName = "Lewis", Ranking = 1780, Email = "amanda.lewis@example.com" },
                new Player { FirstName = "Nicole", LastName = "Lee", Ranking = 1850, Email = "nicole.lee@example.com" },
                new Player { FirstName = "Sarah", LastName = "Walker", Ranking = 1925, Email = "sarah.walker@example.com" },
                new Player { FirstName = "Elizabeth", LastName = "Hall", Ranking = 1975, Email = "elizabeth.hall@example.com" },
                new Player { FirstName = "Robert", LastName = "Johnson", Ranking = 2050, Email = "robert.johnson@example.com" },
                new Player { FirstName = "Andrew", LastName = "Lee", Ranking = 1750, Email = "andrew.lee@example.com" },
                new Player { FirstName = "Steven", LastName = "Chen", Ranking = 1885, Email = "steven.chen@example.com" },
                new Player { FirstName = "Matthew", LastName = "Young", Ranking = 1935, Email = "matthew.young@example.com" },
                new Player { FirstName = "Anthony", LastName = "Wright", Ranking = 2010, Email = "anthony.wright@example.com" }
            };
